...
Route::group(['prefix' => "osce", 'namespace' => 'Modules\Osce\Http\Controllers'], function () {
	...
	Route::group(['prefix' => "theory",'namespace' => 'Admin'], function()
	{
		...
		Route::get('autoexam', ['uses'=>'TestController@autoexam', 'as' => 'osce.theory.autoexam']);//自动组卷提交
		Route::get('onceautoexam', ['uses'=>'TestController@onceautoexam', 'as' => 'osce.theory.onceautoexam']);//重新组卷提交
