...
Route::group(['prefix' => "osce", 'namespace' => 'Modules\Osce\Http\Controllers'], function () {
	...
	Route::group(['prefix' => "cexam", 'namespace' => 'Admin'], function()
	{
		...
		Route::get('modifystudentexam', ['uses'=>'CexamController@MarkingExamREesult','as'=>'osce.cexam.modifystudentexam']);//老师批卷

		Route::post('addstudentresult', ['uses'=>'CexamController@addExameResult','as'=>'osce.cexam.addstudentresult'])->middleware('theoryauth');
		Route::post('modifyresult', ['uses'=>'CexamController@modifyExamREesult','as'=>'osce.cexam.modifyresult']);//老师批卷提交
...
Route::group(['prefix' => "osce", 'namespace' => 'Modules\Osce\Http\Controllers', 'middleware' => []], function () {
	...
	Route::get('admin/index/release-score', ['uses'=>'Admin\IndexController@getReleaseScore','as'=>'osce.admin.index.getReleaseScore']);	//发布成绩
...
//		Route::get('exam-arrange/exam-content',['uses'=>'ExamArrangeController@getExamContent','as'=>'osce.admin.ExamContent.getExamContent']);
		...
		//成绩折算路由
		Route::get('exam-score-corrected/standard-corrected',['uses'=>'ExamScoreCorrectedController@getStandardCorrected','as'=>'osce.admin.ExamScoreCorrected.getStandardCorrected']);
		Route::get('exam-score-corrected/grade-corrected',['uses'=>'ExamScoreCorrectedController@getGradeCorrected','as'=>'osce.admin.ExamScoreCorrected.getGradeCorrected']);
		Route::get('exam-score-corrected/score-corrected',['uses'=>'ExamScoreCorrectedController@getScoreCorrected','as'=>'osce.admin.ExamScoreCorrected.getScoreCorrected']);
...
//		$username = $teacher->userInfo->username;
//		$password =123456;
//
