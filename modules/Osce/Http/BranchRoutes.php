...
Route::group(['prefix' => "osce", 'namespace' => 'Modules\Osce\Http\Controllers', 'middleware' => []], function () {
    ...
    Route::group(['prefix' => 'admin', 'namespace' => 'Admin\Branch'], function () {
        ...
        //答卷查询
        Route::get('examanswer/student-answer', ['uses'=>'ExamAnswerController@getStudentAnswer','as'=>'osce.admin.ExamAnswerController.getStudentAnswer']);
        ...
        //保存成功后，改变队列中的状态为已完成
        Route::post('answer/save-status',['uses'=>'AnswerController@postSaveStatus','as'=>'osce.admin.AnswerController.postSaveStatus']);
