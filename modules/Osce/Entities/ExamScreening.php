...
class ExamScreening extends CommonModel
{
    ...
    protected $guarded = [];
    protected $hidden = [];
    protected $fillable = ['exam_id', 'room_id', 'begin_dt', 'end_dt', 'create_user_id', 'status', 'sort', 'total', 'nfc_tag','real_start_dt'];
