...
class ExamSpecialScore extends  CommonModel
{
    ...
    public function subjectSpecialScore(){
        return $this->hasOne('\Modules\Osce\Entities\SubjectSpecialScore', 'id', 'special_score_id');
    }
    ...
    public function getSpecialScoreBySubject($exam_result_id, $subject_id){
        return $this->where('exam_result_id', '=', $exam_result_id)
                    ->where('subject_id', '=', $subject_id)
                    ->with('subjectSpecialScore')->get();
    }
