...
class ExamScore extends  CommonModel
{
    ...
    protected $guarded      = [];
    protected $hidden       = [];
    protected $fillable     = ['exam_result_id', 'subject_id', 'standard_item_id', 'score', 'evaluate','create_user_id','original_score'];
    ...
    public function getExamScoreData($subjectId){
        $builder = $this;
        $builder = $builder->where('exam_score.subject_id', $subjectId)
