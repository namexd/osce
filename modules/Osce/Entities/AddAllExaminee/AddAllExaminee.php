...
//      $cnFields = ['姓名','性别','学号','身份证号','联系电话','电子邮箱','头像','备注','准考证号','班级','班主任姓名'];
    ...
    {
        $this->regularCheck($examId, $data['idcard'], 'idcard', $key);   //身份证验证
        $this->regularCheck($examId, $data['mobile'], 'mobile', $key);   //手机号
        $this->regularCheck($examId, $data['exam_sequence'], 'exam_sequence', $key); //准考证号
    }
