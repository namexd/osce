...
@section('content')
        ...
        @else
            <input type="hidden" id="parameter" value="{'pagename':'theory_validate','paperUrl':'{{ route('osce.admin.ApiController.getExamPaperId') }}','examUrl':'{{ route('osce.admin.AnswerController.formalPaperList')}}','goUrl':'{{ route('osce.admin.ApiController.LoginAuthView')}}'}" />
