...
<div style="display:none;">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            ...
            <a href="{{route('osce.admin.course.getResultVideo')}}?exam_id={{$result['student']->id}}&student_id={{$result['student']->exam_id}}&station_id={{$result['station_id']}}" class="btn btn-outline btn-default" style="float:right;margin:-10px 10px 0 0;">查看视频</a>
        </div>
