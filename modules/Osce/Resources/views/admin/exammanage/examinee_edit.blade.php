...
@section('content')
 <input type="hidden" id="parameter" value="{'pagename':'examinee_add','preUrl':'{{route('osce.admin.exam.getExamineeManage',['id'=>$item->id])}}'}"/>
    ...
    <div class="row">
     <form method="post" class="form-horizontal" id="sourceForm" action="{{route('osce.admin.exam.postEditExaminee')}}">
      ...
      <div class="col-md-3 col-sm-3">
       <ul class="img_box">
      <li>
        <img src="{{$item->avator}}"><input type="hidden" value="{{$item->avator}}" name="images_path[]"><i class="fa fa-remove font16 del_img"></i>
      </li>
      </span>
      ...
      <div class="col-md-9 col-sm-9">
       ...
       <div class="form-group">
        ...
        <div class="col-sm-10">
         <input type="text"  id="examinee_id" name="examinee_id" class="form-control" value="{{$item->code}}">
        </div>
       </div>
       <div class="hr-line-dashed"></div>
       <div class="form-group">
        ...
        <div class="col-sm-10">
         <input type="text" id="id_number" name="idcard"  class="form-control" value="{{$item->idcard}}">
        </div>
       </div>
       <div class="hr-line-dashed"></div>
       <div class="form-group">
        ...
        <div class="col-sm-10">
         <input type="text"  id="tell" name="mobile" class="form-control" value="{{$item->mobile}}">
        </div>
       </div>
       <div class="hr-line-dashed"></div>
       <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="col-sm-10">
         <textarea name="note" id="" cols="" rows="" class="form-control">{{$item->note}}</textarea>
        </div>
       </div>
       <div class="hr-line-dashed"></div>
       <div class="form-group">
