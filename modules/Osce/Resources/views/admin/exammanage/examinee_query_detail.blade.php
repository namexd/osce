...
@section('content'){{dd($item->userInfo)}}
                    ...
                    <form method="post" class="form-horizontal" id="sourceForm" >
                        ...
                        <div class="col-md-9 col-sm-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="exam_sequence" name="exam_sequence"  class="form-control" value="{{$item->code}}">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="email" name="email" class="form-control" value="{{$item->userInfo->email}}">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
