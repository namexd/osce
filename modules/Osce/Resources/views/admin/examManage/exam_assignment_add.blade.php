...
@section('content')
<input type="hidden" id="parameter" value="{'pagename':'exam_assignment_add','background_img':'{{asset('osce/admin/plugins/js/plugins/layer/laydate')}}','select_exam':'{{route('osce.admin.exam.getExamListData')}}'}" />
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <form method="post" class="form-horizontal" id="sourceForm" action="{{route('osce.admin.exam.postAddExam')}}">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">所属父考试</label>
                            <div class="col-sm-10">
                                <select id="select-exam" class="form-control" style="width:500px;" name="pid" >
                                    {{--<option value="0">无父考试</option>--}}
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                            	<div class="col-md-12">
                            		<div class="clearfix form-group" style="margin-bottom: 0;">
                                        <div class="col-sm-12" id="checkbox_div">
                                            <label class="check_label checkbox_input checkbox_one" style="height: 15px;line-height: 28px;margin-left: 12.7%;">
                                      ...
                                      <div class="clearfix form-group" style="margin-bottom: 0;">
                                           <div class="col-sm-12" id="checkbox_div">
                                                <label class="check_label checkbox_input checkbox_three" style="height: 15px;line-height: 28px;margin-left: 12.7%;">
                                                      ...
                                                      <input type="checkbox" name="real_push" value="0">
