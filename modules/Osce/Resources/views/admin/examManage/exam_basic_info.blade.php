...
@section('content')
<input type="hidden" id="parameter" value="{'pagename':'exam_basic_info','background_img':'{{asset('osce/admin/plugins/js/plugins/layer/laydate')}}','select_exam':'{{route('osce.admin.exam.getExamListData')}}'}" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select id="select-exam" class="form-control" style="width:500px;" name="pid" >
                                        @if($examData->pid != 0)
                                            <option value="{{$examData->pid}}" selected="selected">{{$examData->pidExam}}</option>
                                        @else
