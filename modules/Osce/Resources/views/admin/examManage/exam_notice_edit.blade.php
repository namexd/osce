                    ...
                    <div class="form-group" >
                        ...
                        <div class="col-sm-10 select_code" id="checkbox_div">
                            <label class="check_label checkbox_input">
                                ...
                                <input type="hidden" name="accept[]" {{in_array(1,explode(',',$item->accept))? 'value=1':'disabled="disabled"'}} >
                            ...
                            <label class="check_label checkbox_input">
                                ...
                                <input type="hidden" name="accept[]" {{in_array(2,explode(',',$item->accept))? 'value=2':'disabled="disabled"'}}  >
                            ...
                            <label class="check_label checkbox_input">
                                ...
                                <input type="hidden" name="accept[]" {{in_array(3,explode(',',$item->accept))? 'value=3':'disabled="disabled"'}}  >
