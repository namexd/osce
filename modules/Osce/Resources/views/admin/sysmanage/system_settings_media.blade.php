		                        ...
		                        <div class="clearfix form-group">
		                            ...
		                            <div class="col-sm-10">
		                            	<label class="check_label checkbox_input">
			                                ...
			                                <input type="checkbox" checked="checked" name="type[]" value="微信">
			                                <span class="check_name">微信</span>
			                            </label>
			                            <label class="check_label checkbox_input">
			                                <div class="check_icon" style="display: inline-block"></div>
			                                <input type="checkbox" name="type[]" value="短信">
			                                <span class="check_name">短信</span>
			                            </label>
			                            <label class="check_label checkbox_input">
			                                <div class="check_icon" style="display: inline-block"></div>
			                                <input type="checkbox" name="type[]" value="邮件">
			                                <span class="check_name">邮件</span>
			                            </label>
			                            <label class="check_label checkbox_input">
			                                <div class="check_icon" style="display: inline-block"></div>
			                                <input type="checkbox" name="type[]" value="系统消息">
