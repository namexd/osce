...
@section('content')
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <form class="form-horizontal" id="Form3" novalidate="novalidate" action="/msc/admin/user/teacher-save" method="post">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control code edit-code" name="code" value="{{$item->code}}" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control edit-dept_name" name="dept_name" id="" value="0"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">角色</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control edit-role" name="role" id="0" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">手机号</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control mobile edit-mobile" name="mobile" value="{{$item->user->mobile}}"/>
                    </div>
                </div>
                <div class="form-group">
