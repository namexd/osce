                        ...
                        <form method="post" class="form-horizontal" id="sourceForm" action="{{route('osce.admin.machine.postEditMachine')}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="hidden" required class="form-control" id="cate_id" name="cate_id" value="{{$item['id']}}" />
                                    <input type="hidden" required class="form-control" id="id" name="id" value="1" />
                                </div>
                            </div>
