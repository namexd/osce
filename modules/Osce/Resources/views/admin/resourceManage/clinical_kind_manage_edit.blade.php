...
@section('content')
<input type="hidden" id="parameter" value="{'pagename':'clinical_kind_manage_edit','name':'{{route('osce.admin.kind.postNameUnique')}}'}" />
                ...
                <div class="col-md-12 ">
                    <form method="post" class="form-horizontal" id="sourceForm">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">病种名称</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">病种描述</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                ...
                                <a class="btn btn-white" href="{{route("osce.admin.kind.getKindList")}}">取消</a>
                            </div>
                        </div>
                    </form>
