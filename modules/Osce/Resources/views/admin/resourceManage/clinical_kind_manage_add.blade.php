...
@section('content')
<input type="hidden" id="parameter" value="{'pagename':'clinical_kind_manage_add','name':'{{route('osce.admin.kind.getCreateKind')}}','cancel':'{{route('osce.admin.kind.getKindList')}}'}" />
