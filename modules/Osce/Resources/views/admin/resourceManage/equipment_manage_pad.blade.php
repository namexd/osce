    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row table-head-style1 ">
            ...
            <div class="col-xs-6 col-md-2" style="float: right;">
                <a  href="{{route('osce.admin.machine.getAddPad')}}" class="btn btn-primary" style="float: right;">&nbsp;&nbsp;新增&nbsp;&nbsp;</a>
            </div>
        </div>
                ...
                <div class="input-group" style="margin-bottom: 20px;margin-top: 10px;">
                    ...
                    <div class="btn-group" style="margin-right: 10px;">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{route('osce.admin.machine.getMachineList',['cate_id'=>2])}}">全部</a></li>
                            @forelse($machineStatuValues as $status=>$machineStatuValue)
                                @if(array_key_exists('name',$_GET))
                                    <li><a href="{{route('osce.admin.machine.getMachineList',['cate_id'=>2,'status'=>$status,'name'=>$_GET['name']])}}">{{$machineStatuValue}}</a></li>
                                @else
                                    <li><a href="{{route('osce.admin.machine.getMachineList',['cate_id'=>2,'status'=>$status])}}">{{$machineStatuValue}}</a></li>
                                @endif
                            @empty
                            @endforelse
                        </ul>
