...
@stop
@section('content')
    <input type="hidden" id="parameter" value="{'pagename':'staff_manage_invigilator','deletes':'{{route('osce.admin.invigilator.postDelInvitation')}}','firstpage':'{{route('osce.admin.invigilator.getInvigilatorList')}}','excel':''}" />
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row table-head-style1">
            ...
            <div class="col-xs-6 col-md-3" style="float: right;">
                ...
                <a href="javascript:void(0)" class="btn btn-outline btn-default">下载模板</a>
                <a  href="javascript:void(0)" class="btn btn-outline btn-default" id="file1">导入考生
