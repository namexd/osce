...
@section('content')
<input type="hidden" id="parameter" value="{'pagename':'staff_manage_invigilator_sp_add','code':'{{route('osce.admin.invigilator.postCodeUnique')}}','mobile':'{{route('osce.admin.invigilator.postSelectTeacher')}}','idcard':'{{route('osce.admin.invigilator.postIdcardUnique')}}','email':'{{ route('osce.admin.invigilator.postEmailUnique')}}','url':'{{ url('commom/upload-image') }}','get_subject':'{{route('osce.admin.invigilator.getSubjects')}}'}" />
...
$(function() {
    ...
    $('#cancel-btn').click(function() {
        if(type_status != undefined) {
            ...
            location.href = '{{route("osce.admin.invigilator.getSpInvigilatorList")}}';
        }
    });
})
</script>
