...
@section('content')
    <input type="hidden" id="parameter" value="{'pagename':'equipment_manage_pad_edit','name': '{{route("osce.admin.machine.postNameUnique")}}','code': '{{route("osce.admin.machine.postNameUnique")}}'}" />
