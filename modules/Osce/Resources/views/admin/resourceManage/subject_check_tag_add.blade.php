...
@section('content')
    <div class="ibox float-e-margins">
        <div class="ibox-content">
            <div class="row">
                <div class="col-md-12 ">
                    <form method="post" class="form-horizontal" id="sourceForm" action="{{ route('osce.admin.ExamLabelController.postAddExamQuestionLabel') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" required class="form-control" id="description" name="describe" placeholder="最多输入10个字"/>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
