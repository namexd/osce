...
@section('content')
<input type="hidden" id="parameter" value="{'pagename':'equipment_manage_video','del': '{{route("osce.admin.machine.postMachineDelete")}}','url': '{{route("osce.admin.machine.getMachineList",["cate_id"=>1])}}'}"  />
