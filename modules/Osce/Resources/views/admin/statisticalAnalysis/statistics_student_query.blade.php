            ...
            <div class="center" style="margin-bottom: 40px;">
                @if(!empty(@$examItems))
                    ...
                    <div>
                        ...
                        <span style="margin-left: 1em;">最后得分：</span><span>{{ @$examItems['stuScore'] }}分</span>
                        @if($flag==1)
                            <p style="margin-left: 1em;color: red">该成绩已由另一场考试代替，仅供显示！</p>
                        @elseif($flag==2)
                            <p style="margin-left: 1em;color: red">由于该考生弃考，此成绩仅供显示！</p>
                        @elseif($flag==3)
                            <p style="margin-left: 1em;color: red">由于该考生作弊，此成绩仅供显示！</p>
                        @elseif($flag==4)
                            <p style="margin-left: 1em;color: red">由于该考生替考，此成绩仅供显示！</p>
                        @endif
                    </div>
                @endif
            </div>
