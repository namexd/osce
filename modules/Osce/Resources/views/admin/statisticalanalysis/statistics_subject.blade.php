...
<script src="{{asset('osce/admin/statisticalanalysis/statistics_subject.js')}}"></script>
    <input type="hidden" id="parameter" value="{'pagename':'subject_statistics','ajaxUrl':'{{ route('osce.admin.SubjectStatisticsController.SubjectGradeList') }}','jumpUrl':'{{ route('osce.admin.course.getStudent') }}'}" />
