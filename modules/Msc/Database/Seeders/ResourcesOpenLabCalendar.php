...
class ResourcesOpenLabCalendar extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        foreach($data as $calendar){
            \Modules\Msc\Entities\ResourcesOpenLabCalendar::firstOrCreate($calendar);
        }
    }
    ...
    public function defaultData(){
        ...
        $openlabList    =   \Modules\Msc\Entities\ResourcesClassroom::where('opened','=',1) ->get();
