...
class CreateResourcesLabPlanGroupTable extends Migration {
	...
	*/
	public function up()
	{
		Schema::create('resources_lab_plan_group', function(Blueprint $table) {
			$table->increments('id');
	...
	*/
	...
	{
		Schema::drop('resources_lab_plan_group');
	}
}