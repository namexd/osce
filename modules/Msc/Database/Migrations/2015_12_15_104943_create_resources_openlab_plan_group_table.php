...
class CreateResourcesOpenlabPlanGroupTable extends Migration {
	...
	*/
	public function up()
	{
		Schema::create('resources_openlab_plan_group', function(Blueprint $table) {
			$table->increments('id');
	...
	*/
	...
	{
		Schema::drop('resources_openlab_plan_group');
	}
}