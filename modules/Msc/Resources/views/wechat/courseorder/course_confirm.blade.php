...
@section('content')
    ...
    <div class="w_90"><p class="font16 clo3 mart_5">请确认您的课程预约信息</p></div>
    <div class="add_main mart_5">
        <div class="form-group">
            <label for="">教室名称</label>
            <input type="button" class="form-control set_text"  name="" value="{{ @$ClassroomPlanInfo->name }}" required="">
        </div>

        <div class="form-group">
            <label for="">使用时段</label>
            <input type="button" class="form-control set_text"  name="" value="{{ @$ClassroomPlanInfo->begintime }}-{{ @$ClassroomPlanInfo->endtime }}" required="">
        </div>
    </div>

    <div id="info_list">
        <div id="apply_info" class="w_90" style="">
            <form name="form"   id="frmTeacher" action="{{action('\Modules\Msc\Http\Controllers\WeChat\CourseOrderController@postAddCourseToAplan')}}" method="post" >
                <p class="mart_5">课程名称</p>
                <div class="course_name">
                    <input id="course_name" type="button" class="form-control"  name="course_name" value="{{ @$ClassroomPlanInfo->cname }}"  >
                </div>
                ...
                <input type="hidden" name="rcp" value="{{@$ClassroomPlanInfo->id}}">
                <input class="btn2 mart_20" type="submit"  value="确认使用" />
            </form>
        </div>
    ...
    <div id="leibie_list">
        ...
        <div class="leibie_box" >
            ...
            <div id="add_class" style="display: none">
                ...
                <select class="" name="class_list"  id="class_list" placeholder="输入班级名" style="width:100%;">
            ...
            <div id="add_group" style="display: none">
                ...
                <select class="" name="class_list"  id="group_list" placeholder="输入学生组名" style="width:100%;">
            ...
            <div class="w_96 mart_10 marb_10">
