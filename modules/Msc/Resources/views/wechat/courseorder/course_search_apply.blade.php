...
<div class="w_90"><p class="font16 clo0 mart_5">请确认您的课程预约信息</p></div>
...
<div id="info_list">
    <div id="apply_info" class="w_90" style="">
        <form name="form"   id="frmTeacher" action="{{action('\Modules\Msc\Http\Controllers\WeChat\CourseOrderController@postAddClassRoomApply')}}" method="post" >
            <p class="mart_5">课程名称</p>
            <div class="course_name">
                <input id="course_name" type="text" class="form-control"  name="course_name"  placeholder="请输入课程名">
            </div>
            ...
            <input type="hidden"  name="timestamp" value="{{$ClassroomPlanInfo->currentdate}} {{$ClassroomPlanInfo->begintime}}~{{$ClassroomPlanInfo->currentdate}}{{$ClassroomPlanInfo->endtime}}">
            <input class="btn2 mart_20" type="submit"  value="提交申请" />
    ...
    <div class="wait mart_20" style="display: none;">
        <img src="public/common/img/waiting.png" width="30%"/>
        <p>等待审核中</p>
    </div>
</div>
