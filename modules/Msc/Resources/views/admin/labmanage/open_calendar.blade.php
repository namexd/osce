...
@section('only_css')
    <link rel="stylesheet" href="{{ url('/msc/admin/css/calendar/calendar.css') }}">
    <link rel="stylesheet" href="{{ url('/msc/admin/css/calendar/custom_2.css') }}">
    <style>
        /*may-add*/
...
@stop
@section('only_js')
    <script src="{{ url('/msc/admin/js/calendar2/data.js') }}"></script>
    <script src= "{{ url('/msc/admin/js/calendar2/jquery.calendario.js') }}"></script>
    <script src="{{ url('/msc/admin/js/calendar2/modernizr.custom.js') }}"></script>
    <script>
        $(function(){
//            新增、编辑切换
