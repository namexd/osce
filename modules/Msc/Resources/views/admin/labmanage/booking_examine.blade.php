                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="check_label checkbox_input check_one marb_none">
                                                            <div class="check_real check_icon display_inline" data-id="{{@$list->id}}"></div>
                                                            <input type="hidden" name="" value="">
                                                        </label>
                                                    </td>
...
@section('layer_content')
    ...
    {{--不通过--}}
    <form class="form-horizontal" id="refuse_from" novalidate="novalidate" action="{{route('msc.admin.laboratory.getLabOrderCheck')}}" method="get">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
