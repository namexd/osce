                ...
                <div class="col-md-12">
                    <form method="post" class="form-horizontal" id="sourceForm">
                        ...
                        <div class="hr-line-dashed"></div><div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" ng-model="type" id="description" class="form-control">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" ng-model="description" id="location" class="form-control">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" ng-model="maxorder" id="location" class="form-control">
                            </div>
