	...
	<div class="ibox float-e-margins">
		...
		<div class="ibox-content form-horizontal">
	        ...
	        <div class="btn-group marr_5">
				...
				<div class="btn-group" role="group">
					<select class="form-control cur result_init">
						<option value="0">全部</option>
						<option value="1">良好</option>
						<option value="2">有损</option>
						<option value="3">严重损坏</option>
					</select>
				</div>
	        </div>
	        <button class="btn btn-primary marr_15 inquiry">查询</button>
	        <button class="btn btn-default">导出Excel文件</button>
