    ...
    */
    ...
    'connections' => [
        ...
        'sys_mis' => [
            ...
            'database'  => env('DB_DATABASE_SYS', 'v201_dev_sys_mis'),
			'username'  => env('DB_USERNAME_SYS', 'osce_user'),
			'password'  => env('DB_PASSWORD_SYS', '0431416db0'),
            'charset'   => 'utf8',
            'collation' => 'utf8_unicode_ci',
            'prefix'    => '',
            'strict'    => false,
        ...
        'osce_mis' => [
            ...
            'database'  => env('DB_DATABASE_OSCE', 'v201_dev_osce_mis'),
