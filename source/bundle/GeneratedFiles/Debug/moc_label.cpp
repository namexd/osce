...
QT_MOC_LITERAL(3, 15, 5), // "hover"
QT_MOC_LITERAL(4, 21, 5), // "press"
QT_MOC_LITERAL(5, 27, 5), // "leave"
QT_MOC_LITERAL(6, 33, 4) // "move"

    },
    "Label\0clicked\0\0hover\0press\0leave\0move"
};
...
void Label::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Label::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Label::hover)) {
                *result = 1;
            }
        }
        {
            typedef void (Label::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Label::press)) {
                *result = 2;
            }
        }
        {
            typedef void (Label::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Label::leave)) {
                *result = 3;
            }
        }
        {
            typedef void (Label::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Label::move)) {
                *result = 4;
            }
        }
    }
