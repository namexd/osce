...
public class SubscriberService extends Service {
	...
	// public static final String ACTION_RECIVE_MESSAGE =
	// "com.mx.osce.service.SubscriberService";
	//
	// public static final String TAG = "Subscriber";
	//
	// private SubscriberThread thread;
	//
	// @Override
	// public void onCreate() {
	// super.onCreate();
	// Log.e("DSX", "Service onCreate");
	// JedisPoolConfig poolConfig = new JedisPoolConfig();
	// final JedisPool pool = new JedisPool(poolConfig, "cloud.misrobot.com",
	// 6379, 0);
	// final Subscriber sub = new Subscriber(this);
	// final String channel = "pad_message";
	// new Thread(new Runnable() {
	// public void run() {
	// thread = new SubscriberThread(pool, sub, channel);
	// thread.start();
	// }
	// }).start();
	//
