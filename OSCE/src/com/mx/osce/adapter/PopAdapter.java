...
import com.mx.osce.audio.MediaManage;
...
public class PopAdapter extends BaseAdapter {
	...
	private ArrayList<GradePointBean> gradeListData;
	...
	public PopAdapter(Context context, ArrayList<DataBean> datalist, ArrayList<GradePointBean> mAllPoints) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		case DataBean.AUDIO:
			...
			break;
		case DataBean.CAMERA:
			String savePath = dataList.get(position).getFilePath();
