...
public class GradePointBean implements Parcelable {
	...
	public GradePointBean(Parcel source) {
	...
	public static final Parcelable.Creator<GradePointBean> CREATOR = new Creator<GradePointBean>() {

		@Override
		public GradePointBean createFromParcel(Parcel source) {

			return new GradePointBean(source);
		}

		@Override
		public GradePointBean[] newArray(int size) {
			// TODO Auto-generated method stub
			return new GradePointBean[size];
		}
