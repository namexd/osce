...
=======
<<<<<<< HEAD
		Log.e("现在Activity 数据", mBaseApp.NumberOfActivity() + "");
=======
>>>>>>> local
	}
	
	
	public void showDialog(Context context,String titleText,String contentText,int type){
...
<<<<<<< HEAD
	...
	protected void onDestroy() {
		super.onDestroy();
		Log.e(mScontext.getClass().getSimpleName(), "onDestroy");
