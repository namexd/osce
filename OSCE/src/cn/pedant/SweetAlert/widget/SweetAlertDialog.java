...
public class SweetAlertDialog extends Dialog implements View.OnClickListener, TextWatcher {
	...
	public SweetAlertDialog(Context context, int alertType,boolean isclosewindow) {
