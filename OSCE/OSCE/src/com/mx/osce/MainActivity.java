...
public class MainActivity extends BaseActivity {
	 ...
	 *            考试的房间号
	 */
	public void sendDrawRequest(String watchUid, String room_id, String exam_id) {

		Map<String, String> params = new HashMap<String, String>();
		params.put("uid", watchUid);
		params.put("room_id", room_id);
		params.put("exam_id", exam_id);
		String drawUrl = BaseActivity.mSUrl + Constant.DRAW;
		...
		try {
			GsonRequest<DrawInfor> drawRequest = new GsonRequest<DrawInfor>(Method.GET, drawUrl, DrawInfor.class, null,
					params, new Listener<DrawInfor>() {

						@Override
						public void onResponse(DrawInfor infor) {

							String tips = "定制开发板抽签！--By  DSX" + "\n" + infor.getMessage();// 抽签提示
