...
$(function () {    
    (function ($) {
        $.fn.jalendar = function (options) {
            ...
            dayNames['ZH'] = new Array('周一', '周二', '周三', '周四', '周五', '周六', '周日');
            ...
            monthNames['ZH'] = new Array('一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一', '十二月');
            ...
            $this.find('.events').css('height', "auto" );
            ...
            function prevAddEvent() {
                ...
                $this.children('.jalendar-wood').animate({'width' : "100%"}, 200);
                $this.children('.wood-bottom').animate({'width' : "100%"}, 200);
                $close.hide();
            }
            ...
            $this.on('click', '.this-month', function () {
                ...
                $this.children('.jalendar-wood, .wood-bottom').animate({width : '100%' }, 200, function() {
