$(function() {
    ...
    r.setOption(o);
    var m = echarts.init(document.getElementById("echarts-k-chart")),
        l = {
            title: {
                text: "2013年上半年上证指数"
            },
    ...
    m.setOption(l);
    var i = echarts.init(document.getElementById("echarts-pie-chart")),
        u = {
            title: {
                text: "某站点用户访问来源",
                subtext: "纯属虚构",
    ...
    i.setOption(u);
    var h = echarts.init(document.getElementById("echarts-radar-chart")),
        d = {
            title: {
                text: "预算 vs 开销",
                subtext: "纯属虚构"
    ...
    g.setOption(v);
    var p = echarts.init(document.getElementById("echarts-force-chart")),
        y = {
            title: {
                text: "人物关系：乔布斯",
                subtext: "数据来自人立方",
    ...
    M.setOption(x);
    var b = echarts.init(document.getElementById("echarts-funnel-chart")),
        w = {
            title: {
                text: "漏斗图",
                subtext: "纯属虚构"
