...
/**
 * CustomAnticlockwise---计时不准确，弃用，用CustomTimer
 * @author DELL
 *
 */
@SuppressLint("SimpleDateFormat")
public class CustomAnticlockwise extends Chronometer {
	...
	@SuppressLint("SimpleDateFormat")
	public CustomAnticlockwise(Context context, AttributeSet attrs) {
	...
	public CustomAnticlockwise(Context context) {
		super(context);
