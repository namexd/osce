...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener
{
    ...
    {
        void onSelected(String str, Set<Integer> mSelectedView);
        void onCancel(String str, Set<Integer> mSelectedView);
    }
...
//            lp.rightMargin = clp.rightMargin;
    ...
    public void setSelectedList(Set<Integer> SelectedView)
    {
    ...
    private void doSelect(TagView child, int position)
    {
        if (mAutoSelectEffect)
        {
            if (!child.isChecked())
            {
                ...
                {
                    mOnSelectListener.onSelected((String)mTagAdapter.getItem(position),mSelectedView);
                }
            } else
            {
                ...
                if (mOnSelectListener != null)
                {
                    mOnSelectListener.onCancel((String)mTagAdapter.getItem(position),mSelectedView);
                }
            }
