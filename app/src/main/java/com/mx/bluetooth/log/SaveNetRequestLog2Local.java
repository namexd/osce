...
import com.mx.bluetooth.save.FilePathUtil;
...
public class SaveNetRequestLog2Local {
	...
	public static final String ROOT_DIR = File.separator + "sdcard" + File.separator + "com.mx.bluetooth" + File.separator
			+ "NetRequestLog/";
	...
	public static void SavNetLogLocal(String url, Map<String, String> params, String content) {
		...
		public static boolean SaveScore2Local(String filename, Map<String, String> params) {
			final String DIR = File.separator + "sdcard" + File.separator + "com.mx.bluetooth" + File.separator
					+ "ScoreLog/";		
		...
		public static boolean CopeScore2Success(String filename) {
			final String newDIR = File.separator + "sdcard" + File.separator + "com.mx.bluetooth" + File.separator
					+ "ScoreSuccess/";
			final String oldDIR = File.separator + "sdcard" + File.separator + "com.mx.bluetooth" + File.separator
					+ "ScoreLog/";
