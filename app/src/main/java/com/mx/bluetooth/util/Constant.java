...
public class Constant {
	...
	/** 开启Nfc */
	public static final String ACTION_START_NFC_READER = "com.mx.bluetooth.broadcast.MainActivity.NFC_Start";

	/** 警告后确认结束考试-Action */
	public static final String ACTION_WARN_EXAM_END = "com.mx.bluetooth.broadcast.Force_Warn_End_Exam";

	/** 强制下线 -Action */
	public static final String ACTION_FORCE_OFFINE = "com.mx.bluetooth.broadcast.Force_Off_Line";

	/** 改变当前小组-Action */
	public static final String ACTION_CHANGE_CURRENT_GROUP = "com.mx.bluetooth.broadcast.MainActivity.Current_Group";

	/** 改变下一小组-Action */
	public static final String ACTION_CHANGE_NEXT_GROUP = "com.mx.bluetooth.broadcast.MainActivity.Next_Group";

	/** 改变当前考生-Action */
	public static final String ACTION_CHANGE_CURRENT_STUDENT = "com.mx.bluetooth.broadcast.MainActivity.Current_Student";

	/** PC理论开始考试-Action */
	public static final String ACTION_THEORY_EXAM_BEGIN = "com.mx.bluetooth.broadcast.Force_Begin_Theory_Exam";

	/** PC理论结束考试 */
	public static final String ACTION_THEORY_EXAM_END = "com.mc.osce.broadcast.Force_End_Theory_Exam";

	/** 當前考生放弃考试 */
	public static final String ACTION_GIVE_UP_EXAM = "com.mx.bluetooth.broadcast.Forece_Give_Up_Exam";
	...
	public static final String IGNORE = "/osce/pad/next-student";
}
