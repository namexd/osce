...
public class SweetAlertDialog extends Dialog implements View.OnClickListener,
	...
	private LinearLayout close_window_Layout;

	//
	private EditText mSettingEditText;
	private String mHintString;
	//
	private OnSweetEditListener mSettingEditListener;
	//
	...
	//
	public static interface OnSweetEditListener {
		public void addTextChangedListener(EditText mSettingEditText);
	}

	//
	public SweetAlertDialog(Context context, boolean isclosewindow) {
		this(context, NORMAL_TYPE, isclosewindow);
	}

	public SweetAlertDialog(Context context, int alertType,
			boolean isclosewindow) {
		super(context, R.style.alert_dialog);
		setCancelable(true);// 点击返回键取消对话框
		setCanceledOnTouchOutside(false);//
		this.isclosewindow = isclosewindow;
		mAlertType = alertType;
		mErrorInAnim = OptAnimationLoader.loadAnimation(getContext(),
				R.anim.error_frame_in);
		mErrorXInAnim = OptAnimationLoader.loadAnimation(getContext(),
				R.anim.error_x_in);
		...
		mScaleInAnim = (AnimationSet) OptAnimationLoader.loadAnimation(
				getContext(), R.anim.dialog_scale_in);
		mScaleOutAnim = (AnimationSet) OptAnimationLoader.loadAnimation(
				getContext(), R.anim.dialog_scale_out);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (isclosewindow) {
			close_window_Layout = (LinearLayout) findViewById(R.id.close_window_Layout);
			close_window_Layout.setVisibility(View.VISIBLE);
		...
		//
		mSettingEditText = (EditText) findViewById(R.id.setting_edit);
		mSettingEditText.addTextChangedListener(this);
		//
	...
	//
	public SweetAlertDialog setSettingEdit(String hintStr) {
		mHintString = hintStr;
		if (mSettingEditText != null && mHintString != null) {
			mSettingEditText.setVisibility(View.VISIBLE);
			mSettingEditText.setHint(mHintString);
		}
		return this;
	}
	...
	//
	public SweetAlertDialog setSettingEditListener(OnSweetEditListener listener) {
		mSettingEditListener = listener;
		return this;
	}
	...
	public void afterTextChanged(Editable s) {
		// TODO Auto-generated method stub
		if (mSettingEditListener != null) {
			mSettingEditListener.addTextChangedListener(mSettingEditText);
		}
